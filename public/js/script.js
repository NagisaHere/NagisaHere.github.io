...
// 0 for main page, 1 for project page
var whichPage = 0;
const PAGE_SECTIONS = [
...
const bgTexture = new THREE.TextureLoader().load('/assets/images/bgtheme8.jpg')
...
const reactionTexture = new THREE.TextureLoader().load('/assets/images/clogo.png')
...
const SPLASH_BLOCKS = [
    { position: SPLASH_ESP32_POS, rotation: SPLASH_ESP32_ROT, imagePath: '/assets/images/esp32.png' },
    { position: SPLASH_BLOCK_IMG_POS, rotation: SPLASH_BLOCK_IMG_ROT, imagePath: '/assets/images/block.jpg' },
    { position: SPLASH_JP_POS, rotation: SPLASH_JP_ROT, imagePath: '/assets/images/jp.png' },
    { position: SPLASH_GFL2_POS, rotation: SPLASH_GFL2_ROT, imagePath: '/assets/images/gfl2.jpg' },
    { position: SPLASH_ENDFIELD_POS, rotation: SPLASH_ENDFIELD_ROT, imagePath: '/assets/images/endfield.jpg' },
    { position: SPLASH_CHINA_POS, rotation: SPLASH_CHINA_ROT, imagePath: '/assets/images/china.jpg' },
    { position: SPLASH_RCBAKERY_POS, rotation: SPLASH_RCBAKERY_ROT, imagePath: '/assets/images/rcbakery.png' },
];
...
// github logo
const gitTexture = new THREE.TextureLoader().load('/assets/images/github.png')
...
// linkedin
const linkTexture = new THREE.TextureLoader().load('/assets/images/linkedin.png')
...
function pleaseHelpMe({ text, textSize, textColour, position }) {
    ...
    outText.font = '/assets/fonts/Noto_Sans_JP/static/NotoSansJP-Regular.ttf'
...
function drawTitle() {
    ...
    loader.load('/assets/fonts/Noto Sans JP_Regular.json', function(leFont) {
        generateFont({
            font: leFont,
            text: "  Ryan.Dev    ",
