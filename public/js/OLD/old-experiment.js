...
const reactionTexture = new THREE.TextureLoader().load('/assets/images/live.png')
...
// le bgm
const bgTexture = new THREE.TextureLoader().load('/assets/images/bgtheme7.jpg')
...
// genki thingy
const genkiTexture = new THREE.TextureLoader().load('/assets/images/APA.png')
